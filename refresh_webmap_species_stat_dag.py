# This DAG refreshs the webmap database species_stat materialzied view.
...
with DAG(
    dag_id='refresh_webmap_db_species_stat_view',
    ...
    def view_refresh(ds, **kwargs):
        ...
        sql = 'REFRESH MATERIALIZED VIEW webmap.species_stat'
    ...
    task = PythonOperator(
        task_id='refresh_webmap_species_stat',
