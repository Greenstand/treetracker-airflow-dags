...
def pre_request_map_clusters(url_prefix):
  ...
  request(2,15, "map_name=rejuvenate_umhlaba")
  request(2,15, "map_name=TreesThatFeedFoundation")
  request(2,15, "map_name=echo")
  request(2,15, "map_name=bosque-la-tigra")
  request(2,15, "map_name=bondy")
  request(2,15, "map_name=forestfocus")
  request(2,15, "map_name=inception")
