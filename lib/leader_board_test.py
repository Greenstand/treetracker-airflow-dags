...
from lib.leader_board import getLeaderBoard, insertLeaderBoard   # The test framework
...
class Test_Leaderboard(unittest.TestCase):
    def test_leaderboard(self):
        ...
        result = insertLeaderBoard()
        # use unittest to check the result
        self.assertTrue(result)

if __name__ == '__main__':
    # Run the unit tests in the test suite with name 'Test_Leaderboard'
    unittest.main()